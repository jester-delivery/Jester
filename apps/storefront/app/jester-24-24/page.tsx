...
import CartFloatingButton from "@/components/jester24/CartFloatingButton";
...
export default function Jester2424Page() {
  ...
  return (
    <main className="min-h-screen text-white bg-gradient-to-b from-[#050610] via-[#040411] to-[#050610] pb-24">
      {/* Sticky Header + Tabs (cu thumbnail pe fiecare tab) */}
      <header className="sticky top-0 z-40 w-full border-b border-white/10 bg-[#050610]/90 backdrop-blur-md">
